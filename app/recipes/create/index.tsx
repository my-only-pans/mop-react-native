...
const sampleRecipe: Recipe = {
  title: "Shoyu Ramen",
  description:
    "This is the ramen egg that we all know and enjoy. This can also be a snack.",
  serving: 2,
  equipments: ["small pot", "measuring spoon", "knife", "cutting board"],
  ingredients: [
    { item: "large egg", qty: 4, unit: "pcs" },
...
function CreateRecipe(props: Recipe) {
  ...
  const [savedEquipments, setSavedEquipments] = useState([
    "pan",
    "oven",
    "knife",
  ]);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity style={styles.btnStep} onPress={onPrev}>
          <Text style={styles.btnText}>
            <Icon name="arrow-left-circle" type="material-community" /> Prev
          </Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.btnStep} onPress={onNext}>
          <Text style={styles.btnText}>
            {" "}
            Next <Icon name="arrow-right-circle" type="material-community" />
          </Text>
        </TouchableOpacity>
      </View>
    </View>
