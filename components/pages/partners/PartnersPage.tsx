...
const PartnershipPage = () => {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text variant="displayLarge" style={styles.headline}>Partnership and Partners</Text>
      ...
      <Title style={styles.title}>Benefits of Partnership</Title>
      <Text style={styles.paragraph}>
      ...
      <Title style={styles.title}>Types of Partnerships</Title>
      <Text style={styles.paragraph}>
      ...
      <Title style={styles.title}>Partner Requirements</Title>
      <Text style={styles.paragraph}>
      ...
      <Title style={styles.title}>How to Become a Partner</Title>
      <Text style={styles.paragraph}>
...
const styles = StyleSheet.create({
  ...
  partnerDisplayContainer: {
    padding: 0,
    marginBottom: 5, // Adjust this value to change the amount of space the PartnerDisplay takes
  },
});
